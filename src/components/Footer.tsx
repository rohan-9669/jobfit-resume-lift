      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mt-2">
              Get a Sureshot Shortlisted Resume with AI-Optimized Precision
            </p>
            <div className="flex space-x-4 pt-2">
              {/* Social icons would go here */}
              <div className="h-8 w-8 rounded-full bg-blue-100 dark:bg-blue-800/30 flex items-center justify-center">
                <span className="sr-only">Twitter</span>
                <div className="h-4 w-4 bg-blue-400 dark:bg-blue-600 rounded-full"></div>
              </div>
              <div className="h-8 w-8 rounded-full bg-blue-100 dark:bg-blue-800/30 flex items-center justify-center">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/pricing" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm">Pricing</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-gray-500 dark:text-gray-400 text-xs text-center">
            &copy; {new Date().getFullYear()} TailoredResumeAI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
